...
func (generator *GraphGenerator) Complete(V int) *Graph {
	g, _ := generator.SimpleP(V, 1.0)
	return g
}

// CompleteBipartite returns a complete bipartite graph on V1 and V2 vertices.
func (generator *GraphGenerator) CompleteBipartite(V1, V2 int) *Graph {
	g, _ := generator.BipartiteGraph(V1, V2, V1*V2)
	return g
}
